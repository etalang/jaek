...
{
public:
    CodePrinter(ostream* hStream, ostream* cppStream, ostream* xiStream):
        hStream(hStream), cppStream(cppStream), xiStream(xiStream) {}

    void printCode(ostream& out, int baseIndent, const string& code,
                   int baseLine, string linePrefix = "");
    ...
    ostream& ind(CodeStream str,int ind);
